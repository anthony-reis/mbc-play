  ...
  return (
    <div className="relative w-2/3 lg:w-full max-w-[889px]">
      <div className="relative flex items-center">
        <Search className="absolute left-3 md:left-4 lg:left-5 h-4 w-4 md:h-5 md:w-5 text-zinc-500 pointer-events-none z-10" />
        ...
        <Input
          ...
          className="
            ...
            h-small:h-10
            h-xs:h-9
            w-full rounded-[30px] border-none bg-[#212121]
